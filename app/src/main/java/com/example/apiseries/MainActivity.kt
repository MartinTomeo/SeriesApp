...
import com.example.apiseries.database.AppDataBase
import com.example.apiseries.database.ShowDAO
import com.example.apiseries.database.ShowDbItem
import com.example.apiseries.databinding.ActivityMainBinding
import com.example.apiseries.model.ShowModel
import com.example.apiseries.model.api.ApiResult
import com.example.apiseries.view.MainAdapter
        ...
        CoroutineScope(Dispatchers.IO).launch {
            runBlocking { // Prevents duplicates by waiting for coroutine to finish
                ...
                if (existingSearch == null) {
                    val searchHistoryItem = ShowDbItem(
                        title = data
                    )
